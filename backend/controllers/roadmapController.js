  ...
  'Software Engineer': {
    student: {
      ...
      milestones: [
        ...
        { phase: 'Final Year — Campus Placement', duration: '6 Months', emoji: '🏆', status: 'upcoming', description: 'Crack campus placements or apply on CareerSeal. Target service companies first then product.', actions: ['Apply on CareerSeal 6 months before graduation', 'Practice mock interviews', 'Complete your CareerSeal GRID profile'], skills: ['Interview prep', 'System design basics', 'GRID profile'] }
      ],
  ...
  'Doctor / MBBS': {
    student: {
      ...
      milestones: [
        ...
        { phase: 'MBBS — 5.5 Years', duration: '5.5 Years', emoji: '🏥', status: 'upcoming', description: 'Complete MBBS including 1 year internship. Choose a specialization direction early.', actions: ['Focus on clinical skills during internship', 'Decide on specialization (Surgery, Paediatrics, Cardiology etc)', 'Build your CareerSeal GRID profile'], skills: ['Clinical skills', 'Patient care', 'Medical knowledge'] },
        ...
        { phase: 'Career — Practice or Abroad', duration: 'Ongoing', emoji: '🏆', status: 'upcoming', description: 'Start practice in India or clear USMLE/PLAB for USA/UK. Doctors abroad earn $200k+.', actions: ['Start own clinic or join hospital', 'Clear USMLE for USA or PLAB for UK if interested', 'Build reputation through CareerSeal verified profile'], skills: ['Medical practice', 'USMLE/PLAB', 'Patient management'] }
      ],
    ...
    experienced: {
      ...
      milestones: [
        ...
        { phase: 'Own Practice or Senior Role', duration: 'Ongoing', emoji: '🏆', status: 'upcoming', description: 'Start own clinic or join as senior consultant in a top hospital.', actions: ['Build patient base through reputation', 'List your practice on CareerSeal', 'Join hospital as senior consultant for stable income'], skills: ['Practice management', 'Team leadership', 'Business skills'] }
      ],
  ...
  if (!careerData) {
    return {
      ...
      milestones: [
        ...
        { phase: 'Phase 3 — First Job', duration: '6 Months', emoji: '🏆', status: 'upcoming', description: 'Apply for entry level positions. Use your CareerSeal GRID profile to stand out.', actions: ['Apply to 5 jobs daily on CareerSeal', 'Complete your GRID profile and publish', 'Prepare for interviews with mock practice'], skills: ['Interview prep', 'GRID profile', 'Job search'] }
      ],
      aiInsight: `${career} is a great career choice. Stay consistent, keep learning and use your CareerSeal GRID profile to get discovered by the right employers.`
    }
  }
