    ...
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-10 md:px-16">
        <div className="max-w-md w-full mx-auto">
          ...
          <p className="text-gray-400 text-sm mb-6">Are you a recruiter? <span className="text-[#0D7377] font-bold cursor-pointer" onClick={() => navigate('/register-company')}>Register as Company →</span></p>
