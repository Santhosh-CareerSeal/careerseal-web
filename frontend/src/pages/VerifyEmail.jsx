...
function VerifyEmail() {
  ...
  const handleVerify = async (code) => {
    ...
    setLoading(true)
    try {
      await axios.post(`${API_URL}/api/otp/verify`, { email, otp: code })
      setSuccess('Email verified! Redirecting to login...')
      setTimeout(() => navigate('/login', { state: { message: 'Email verified! Please sign in.' } }), 2000)
    } catch (e) {
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl p-8">
          <div className="text-center mb-6">
            ...
            <h1 className="text-xl font-bold text-[#1A3C6E] mb-2">Verify your email</h1>
          ...
          <div className="text-center">
            {canResend ? (
              <button onClick={handleResend} disabled={resending}
                className="text-[#0D7377] font-bold text-sm hover:underline disabled:opacity-50">
