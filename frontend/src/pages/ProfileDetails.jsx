      ...
      try {
        ...
        if (s) {
          setForm(f => ({
            ...
            aadhaarNumber: s.aadhaarNumber || '', digiLockerStatus: s.digiLockerStatus || '',
            bio: s.bio || ''
          }))
            ...
            <div className="flex flex-col gap-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" placeholder="e.g. St. Mary's High School" value={form.schoolName} onChange={e => set('schoolName', e.target.value)} className={inputClass} />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input type="text" placeholder="e.g. 2018" value={form.schoolPassingYear} onChange={e => set('schoolPassingYear', e.target.value)} className={inputClass} />
                  </div>
                  <div>
                    <label className={labelClass}>Percentage / CGPA</label>
                    <input type="text" placeholder="e.g. 85%" value={form.schoolPercentage} onChange={e => set('schoolPercentage', e.target.value)} className={inputClass} />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" placeholder="e.g. Delhi Public School" value={form.twelfthSchoolName} onChange={e => set('twelfthSchoolName', e.target.value)} className={inputClass} />
                  </div>
                  <div>
                    <label className={labelClass}>Board</label>
                  ...
                  <div>
                    <label className={labelClass}>Passing year</label>
                    <input type="text" placeholder="e.g. 2020" value={form.twelfthPassingYear} onChange={e => set('twelfthPassingYear', e.target.value)} className={inputClass} />
                  </div>
                  <div>
                    <label className={labelClass}>Percentage / CGPA</label>
                    <input type="text" placeholder="e.g. 88%" value={form.twelfthPercentage} onChange={e => set('twelfthPercentage', e.target.value)} className={inputClass} />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" placeholder="e.g. MIT" value={form.collegeName} onChange={e => set('collegeName', e.target.value)} className={inputClass} />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input type="text" placeholder="e.g. Computer Science" value={form.branch} onChange={e => set('branch', e.target.value)} className={inputClass} />
                  </div>
                  <div>
                    <label className={labelClass}>Passing year</label>
                    <input type="text" placeholder="e.g. 2024" value={form.collegePassingYear} onChange={e => set('collegePassingYear', e.target.value)} className={inputClass} />
                  </div>
                  <div>
                    <label className={labelClass}>CGPA / Percentage</label>
                    <input type="text" placeholder="e.g. 8.5 / 85%" value={form.collegeCGPA} onChange={e => set('collegeCGPA', e.target.value)} className={inputClass} />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className={labelClass}>College / University</label>
                    <input type="text" placeholder="e.g. IIM Bangalore" value={form.pgCollegeName} onChange={e => set('pgCollegeName', e.target.value)} className={inputClass} />
                  </div>
                  <div>
                    <label className={labelClass}>Degree</label>
                  ...
                  <div>
                    <label className={labelClass}>Branch / Specialization</label>
                    <input type="text" placeholder="e.g. Data Science" value={form.pgBranch} onChange={e => set('pgBranch', e.target.value)} className={inputClass} />
                  </div>
                  <div>
                    <label className={labelClass}>Passing year</label>
                    <input type="text" placeholder="e.g. 2026" value={form.pgPassingYear} onChange={e => set('pgPassingYear', e.target.value)} className={inputClass} />
                  </div>
                  <div>
                    <label className={labelClass}>CGPA / Percentage</label>
                    <input type="text" placeholder="e.g. 9.0 / 90%" value={form.pgCGPA} onChange={e => set('pgCGPA', e.target.value)} className={inputClass} />
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  {['Student', 'Fresher', 'Experienced'].map(s => (
                    <button key={s} onClick={() => set('workStatus', s)} className={`border-2 rounded-xl p-3 text-sm font-bold transition-all ${form.workStatus === s ? 'border-[#0D7377] bg-[#0D7377]/5 text-[#1A3C6E]' : 'border-gray-200 text-gray-500'}`}>
                      {s}
                    </button>
                  ))}
                </div>
              ...
              {(form.workStatus === 'Experienced') && (
                <>
                  <div>
                    ...
                    <input type="text" placeholder="e.g. Infosys" value={form.currentCompany} onChange={e => set('currentCompany', e.target.value)} className={inputClass} />
                  </div>
                  <div>
                    <label className={labelClass}>Job title</label>
                    <input type="text" placeholder="e.g. Software Engineer" value={form.jobTitle} onChange={e => set('jobTitle', e.target.value)} className={inputClass} />
                  </div>
                </>
              )}

              <div>
                <label className={labelClass}>Work experience / description</label>
                <textarea placeholder="Describe your work experience, internships, projects..." value={form.workExperience} onChange={e => set('workExperience', e.target.value)} className={`${inputClass} h-24`} />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input type="text" placeholder="e.g. Bangalore, Remote" value={form.preferredWorkLocation} onChange={e => set('preferredWorkLocation', e.target.value)} className={inputClass} />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input type="text" placeholder="e.g. 5-8 LPA" value={form.expectedSalary} onChange={e => set('expectedSalary', e.target.value)} className={inputClass} />
                </div>
              </div>
          ...
          {activeTab === 3 && (
            <div className="flex flex-col gap-4">
              ...
              <div>
                ...
                <input type="text" placeholder="e.g. React, Node.js, Python, SQL" value={form.technicalSkills} onChange={e => set('technicalSkills', e.target.value)} className={inputClass} />
                <p className="text-xs text-gray-400 mt-1">Separate skills with commas</p>
              </div>

              <div>
                <label className={labelClass}>Soft skills</label>
                <input type="text" placeholder="e.g. Leadership, Communication, Teamwork" value={form.softSkills} onChange={e => set('softSkills', e.target.value)} className={inputClass} />
              </div>

              <div>
                <label className={labelClass}>Tools and software</label>
                <input type="text" placeholder="e.g. VS Code, Figma, Git, Postman" value={form.toolsAndSoftware} onChange={e => set('toolsAndSoftware', e.target.value)} className={inputClass} />
              </div>

              <div>
                <label className={labelClass}>Languages known</label>
                <input type="text" placeholder="e.g. English, Hindi, Telugu" value={form.languagesKnown} onChange={e => set('languagesKnown', e.target.value)} className={inputClass} />
              </div>

              <div>
                <label className={labelClass}>Certifications</label>
                <textarea placeholder="e.g. AWS Certified Developer - 2024, Google Analytics - 2023" value={form.certifications} onChange={e => set('certifications', e.target.value)} className={`${inputClass} h-20`} />
              </div>
          ...
          {activeTab === 4 && (
            <div className="flex flex-col gap-4">
              ...
              <div>
                ...
                <textarea placeholder="Write 2-3 lines about yourself, your goals and what you bring to the table..." value={form.bio} onChange={e => set('bio', e.target.value)} className={`${inputClass} h-24`} />
              </div>

              <div>
                <label className={labelClass}>Hobbies</label>
                <input type="text" placeholder="e.g. Chess, Photography, Reading" value={form.hobbies} onChange={e => set('hobbies', e.target.value)} className={inputClass} />
              </div>

              <div>
                <label className={labelClass}>PF account number</label>
                <input type="text" placeholder="e.g. KA/BNG/1234567/000/0000000" value={form.pfAccountNumber} onChange={e => set('pfAccountNumber', e.target.value)} className={inputClass} />
              </div>

              <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
                <p className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-3">Verification</p>
                <div className="flex flex-col gap-3">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-bold text-gray-700">Aadhaar</p>
                      <p className="text-xs text-gray-400">Real eKYC integration coming soon</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-400">Document verification coming soon</p>
                    </div>
                    <span className="text-xs font-bold px-3 py-1 rounded-full bg-amber-100 text-amber-800">Pending</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-400">Verified at registration</p>
                    </div>
                ...
                <div className="flex gap-3 items-center">
                  ...
                  <div className="flex items-center gap-2 flex-1">
                    ...
                    <div className="relative">
                      <button onClick={() => setShowGridInfo(!showGridInfo)} className="w-8 h-8 rounded-full border-2 border-gray-300 text-gray-500 text-sm font-bold hover:border-[#0D7377] hover:text-[#0D7377] transition-colors flex items-center justify-center">
                        i
                      </button>
                      {showGridInfo && (
                        <div className="absolute bottom-10 right-0 w-56 bg-[#1A3C6E] text-white text-xs rounded-xl p-3 z-10">
                          <p className="font-bold mb-1">Move to GRID</p>
                          <p className="text-white/80 leading-relaxed">Publishing your profile to GRID makes it visible to companies and recruiters. You can only do this <span className="font-bold text-[#5DCAA5]">3 times per month</span> — so make sure your profile is complete before publishing.</p>
