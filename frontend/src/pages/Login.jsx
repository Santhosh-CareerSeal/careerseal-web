      ...
      <div className="flex-1 flex flex-col justify-center px-8 md:px-16 py-12 bg-white">
        <div className="max-w-sm mx-auto w-full">
          ...
          <button onClick={() => handleOAuthPlaceholder('Zoho')} disabled={connecting === 'Zoho'}
            className="w-full flex items-center justify-center gap-3 border border-gray-200 rounded-xl py-3 mt-3 text-sm font-bold text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-50">
