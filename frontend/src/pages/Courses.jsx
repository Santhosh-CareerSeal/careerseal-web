    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-[#1A3C6E] px-6 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center gap-5">
          ...
          <button onClick={() => navigate('/exams')} className="text-white/60 text-sm hover:text-white">Skill Exams</button>
          <button className="text-white text-sm font-bold border-b-2 border-[#0D7377] pb-0.5">Courses</button>
