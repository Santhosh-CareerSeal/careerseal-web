  ...
  'Doctor / MBBS': {
    student: {
      ...
      milestones: [
        ...
        { phase: 'MBBS — 5.5 Years', duration: '5.5 Years', emoji: '🏥', status: 'upcoming', description: 'Complete MBBS including 1 year internship. Choose a specialization direction early.', actions: ['Focus on clinical skills during internship', 'Decide on specialization (Surgery, Paediatrics, Cardiology etc)', 'Build your GRID GRID profile'], skills: ['Clinical skills', 'Patient care', 'Medical knowledge'] },
  ...
  if (!careerData) {
    return {
      ...
      milestones: [
        ...
        { phase: 'Phase 3 — First Job', duration: '6 Months', emoji: '🏆', status: 'upcoming', description: 'Apply for entry level positions. Use your GRID GRID profile to stand out.', actions: ['Apply to 5 jobs daily on GRID', 'Complete your GRID profile and publish', 'Prepare for interviews with mock practice'], skills: ['Interview prep', 'GRID profile', 'Job search'] }
      ],
      aiInsight: `${career} is a great career choice. Stay consistent, keep learning and use your GRID GRID profile to get discovered by the right employers.`
    }
  }
